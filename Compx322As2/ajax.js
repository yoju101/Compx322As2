...
function removeTown(selectedTown) {
  ...
  // Remove the town from the array used for drawing graphs
  let indexToRemove = selectedLocations.findIndex(location => location.name === selectedTown);
  if (indexToRemove !== -1) {
  ...
  function TownWidget(townArray) {
    ...
    this.display = function () {
      // Create the widget container and adding a boarder
      let widgetContainer = document.createElement("div");
      widgetContainer.classList.add("town-widget");
      widgetContainer.style.border = "2px solid #000";
      ...
      // Add town information to the widget
